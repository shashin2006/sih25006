...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#FFF1F1" }, // light pink background
  header: { flexDirection: "row", alignItems: "center", backgroundColor: "#B91C1C", padding: 15 },
  ...
  userMessage: { alignSelf: "flex-end", backgroundColor: "#EF4444" }, // bright red user bubble
  botMessage: { alignSelf: "flex-start", backgroundColor: "#FEE2E2", borderWidth: 1, borderColor: "#FCA5A5" }, // light pink bot bubble
  messageText: { color: "black" },
  inputContainer: { flexDirection: "row", padding: 10, borderTopWidth: 1, borderColor: "#FCA5A5", backgroundColor: "white" },
  input: { flex: 1, borderWidth: 1, borderColor: "#FCA5A5", borderRadius: 20, paddingHorizontal: 12, marginRight: 10 },
  sendButton: { backgroundColor: "#B91C1C", borderRadius: 20, paddingHorizontal: 20, justifyContent: "center" }, // dark red send
});
